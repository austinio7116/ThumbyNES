...
#ifdef CZ80_SZHVC_IN_FLASH
/* ThumbyNES: tables precomputed by tools/gen_md_cz80_szhvc.c and
 * linked as const flash data. Saves 256 KB of BSS during MD sessions. */
extern const UINT8 md_cz80_szhvc_add_data[2*256*256];
extern const UINT8 md_cz80_szhvc_sub_data[2*256*256];
#define SZHVC_add ((UINT8 *)md_cz80_szhvc_add_data)
#define SZHVC_sub ((UINT8 *)md_cz80_szhvc_sub_data)
#else
